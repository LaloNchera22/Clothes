    ...
    <div className="min-h-screen bg-white text-black p-8 font-mono">
      ...
      <div className="max-w-xl mx-auto space-y-8 mt-24">
        ...
        <div className="space-y-4 text-sm leading-relaxed text-stone-600">
          <p>By engaging with the A0_BADX infrastructure, you agree to abide by the following stipulations:</p>
          <ul className="list-disc pl-5 space-y-2">
             ...
             <li>The archive&apos;s content remains the intellectual property of A0_BADX.</li>
          </ul>
        </div>
      </div>
    </div>
